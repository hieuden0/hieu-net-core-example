...
namespace TA.Data
{
    public partial class Html5Context : DbContext
    {
        ...
        public virtual DbSet<Z_Store> Z_Store { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer(@"Server =.; Database = html5; Trusted_Connection = True; MultipleActiveResultSets = true; Persist Security Info = True; User ID = sa; Password = Hieubui123");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //*************************//
            modelBuilder.Entity<Z_Store>(entity =>
            {
                entity.ToTable("z_store");
